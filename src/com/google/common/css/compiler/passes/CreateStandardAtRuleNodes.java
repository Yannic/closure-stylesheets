 ...
 *
 */
public class CreateStandardAtRuleNodes implements NewCssCompilerPass {
  ...
  public boolean run(JobDescription job, CssTree cssTree, ErrorManager errorManager) {
    Preconditions.checkNotNull(cssTree);
    ...
    visitController.startVisit(
        UniformVisitor.Adapters.asVisitor(new Visitor(visitController, errorManager)));
    return true;
  }

  private static class Visitor implements UniformVisitor {
