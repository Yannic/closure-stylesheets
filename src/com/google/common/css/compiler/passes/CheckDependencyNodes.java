 ...
 */
public class CheckDependencyNodes implements NewCssCompilerPass {

  // Used for testing only!
  private List<String> providesInOrder = null;

  public CheckDependencyNodes() {}

  @Override
  public boolean run(JobDescription job, CssTree cssTree, ErrorManager errorManager) {
    MutatingVisitController visitController = cssTree.getMutatingVisitController();
    Visitor visitor = new Visitor(visitController, errorManager, job.suppressDependencyCheck);
    visitController.startVisit(visitor);
    providesInOrder = visitor.getProvidesInOrder();
    return true;
  }

  @VisibleForTesting
  List<String> getProvidesInOrder() {
    return providesInOrder;
  }

  private static class Visitor extends DefaultTreeVisitor {
    ...
    public Visitor(MutatingVisitController visitController, ErrorManager errorManager,
    ...
    private List<String> getProvidesInOrder() {
